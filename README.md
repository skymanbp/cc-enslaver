...
[![Plugin Version](https://img.shields.io/badge/version-0.11.0-blue.svg)](CHANGELOG.md)
...
`cc-enslaver` ships a **layered defense** against all six, currently 9 rules and 6 Stop-hook gates (v0.11.0):
