...
[![Plugin Version](https://img.shields.io/badge/version-0.25.0-blue.svg)](CHANGELOG.md)
...
`cc-enslaver` ships a **layered defense** against all seven, currently **12 built-in rules + user-defined Imperial Edicts (圣旨) + 9 Stop-hook gates** (v0.25.0):
...
### 防御分层（**v0.25.0**：12 内置规则 + 用户自定义圣旨 + Stop 钩子 9 层闸门）
