...
| 08 | Read-before-edit · think-before-write | Before any `Edit`: full Read of target + call sites + connected files; in your reply explicitly answer ≥ 3 of the six keyword groups the hook counts (root cause / architecture / responsibility / solution / impact / risk). Violation → Stop **layer (e)** BLOCK. |
